...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/flow/expenseFlow/">费用报销列表</a></li>
		<shiro:hasPermission name="flow:expenseFlow:edit"><li><a href="${ctx}/flow/expenseFlow/form">费用报销添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="expenseFlow" action="${ctx}/flow/expenseFlow/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="expenseFlow">
			<tr>
				<td><a href="${ctx}/flow/expenseFlow/form?id=${expenseFlow.id}">
				...
				<td>
					${expenseFlow.expenseStatusValue}
				</td>
				<shiro:hasPermission name="flow:expenseFlow:edit"><td>
    				<a href="${ctx}/flow/expenseFlow/form?id=${expenseFlow.id}">详情</a>
<%-- 					<a href="${ctx}/flow/expenseFlow/delete?id=${expenseFlow.id}" onclick="return confirmx('确认要删除该费用报销吗？', this.href)">删除</a> --%>
