...
<!-- 							</td> -->
		...
		<div class="form-actions">
			<shiro:hasPermission name="oa:oaDemandManagement:edit"><input id="btnSubmit" class="btn btn-primary" type="button" value="同意" onclick="commentClick('yes')"/>&nbsp;</shiro:hasPermission>
			<shiro:hasPermission name="oa:oaDemandManagement:edit"><input id="btnSubmit" class="btn btn-primary" type="button" value="驳回" onclick="commentClick('no')"/>&nbsp;</shiro:hasPermission>
