...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/oa/oaDemandManagement/listImplement">需求发起列表</a></li>
		<shiro:hasPermission name="oa:oaDemandManagement:edit"><li><a href="${ctx}/oa/oaDemandManagement/formImplement">需求发起</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="demandManagement" action="${ctx}/oa/oaDemandManagement/listImplement" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="oaDemandManagement">
			<tr>
				<td>
					<a href="${ctx}/oa/oaDemandManagement/formImplement?id=${oaDemandManagement.id}">
				...
				<shiro:hasPermission name="oa:oaDemandManagement:edit"><td>
    				<a href="${ctx}/oa/oaDemandManagement/formImplement?id=${oaDemandManagement.id}">详情</a>
