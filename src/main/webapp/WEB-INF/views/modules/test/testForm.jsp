		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="user" name="user.id" value="${user.user.id}" labelName="user.name" labelValue="${user.office.name}"
					title="用户" url="/sys/office/treeData?type=3" includeExEmployee="true" cssClass="required"  allowClear="true" notAllowSelectParent="true"/>
                ...
                <sys:treeselect id="user2" name="user.id" value="${user.user.id}" labelName="user.name" labelValue="${user.office.name}"
					title="用户" url="/sys/office/treeData?type=3" includeExEmployee="true" cssClass="required" notAllowSelectParent="true" checked="true"/>
