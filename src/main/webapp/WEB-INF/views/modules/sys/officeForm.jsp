...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/office/list?id=${office.parent.id}">机构列表</a></li>
		<li class="active"><a href="${ctx}/sys/office/form?id=${office.id}&parent.id=${office.parent.id}">机构<shiro:hasPermission name="sys:office:edit">${not empty office.id?'编辑':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:office:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group">
            <label class="control-label"><span style="color: red;">*</span>机构编码:</label>
            <div class="controls">
		...
		<div class="control-group">
			<label class="control-label"><span style="color: red;">*</span>是否可用:</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				 <sys:treeselect id="deputyPerson" name="deputyPersonIdList" value="${office.deputyPerson}" labelName="deputyPersonNameStr" labelValue="${office.deputyPersonNameStr}"
					title="用户" url="/sys/office/treeData?type=3&exclusionExOffice=true" includeExEmployee="false" checked="true" allowClear="true" notAllowSelectParent="true"/>
			</div>
		</div>
		<div class="control-group">
