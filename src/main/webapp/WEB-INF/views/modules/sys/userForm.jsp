...
<body>
	...
	<form:form id="inputForm" modelAttribute="user"
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="office" name="office.id"
					...
					url="/sys/office/treeData?type=2" cssStyle="true"
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="email" htmlEscape="false" maxlength="100" onfocus="$(this).attr('readonly',false)" onblur="$(this).attr('readonly',true)" readonly="true"
					class="email required" autocomplete="off" />
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input id="newPassword" name="newPassword" autocomplete="new-password" type="password" value=""
		...
		<div class="control-group">
			...
			<div class="controls">
<%-- 				<form:checkboxes path="postNameList" items="${allPostName}" --%>
<%-- 					itemLabel="postName" itemValue="id" htmlEscape="false" --%>
<%-- 					class="required" /> --%>
				<form:select path="postNameList" class="input-large required" multiple="false">
				<form:option value="" label="请选择"/>
					<form:options items="${allPostName}"
						itemLabel="postName" itemValue="id" htmlEscape="false" />
				</form:select>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="rank" class="input-large" >
					<form:option value="" label="请选择"/>
					<form:options items="${jobLevel}"
						itemLabel="levelName" itemValue="id" htmlEscape="false" />
				</form:select>
			</div>
		</div>
...
<%-- 					itemLabel="name" itemValue="id" htmlEscape="false" class="required" /> --%>
				<form:select path="roleIdList" class="input-large required" multiple="true">
<%-- 					<form:option value="" label="请选择"/> --%>
