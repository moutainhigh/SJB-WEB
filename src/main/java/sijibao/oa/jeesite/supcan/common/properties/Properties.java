...
import sijibao.oa.jeesite.supcan.annotation.common.properties.SupProperties;
...
public class Properties {
	...
	/**
	 * 当前行的颜色，允许多个颜色渐变 颜色串, 支持ARGB格式，例如: "#10C0D0E0", 其中 "10" 是 alpha(透明度), "C0D0E0" 是 RGB, 此外, 还支持包含如下边框属性： borderWidth
	 * - 边框线宽 borderColor - 边框线色 borderRound - 边框线的圆角直径 示例: "#12FFFFFF,#22EEFFEE; borderWidth=1; borderColor=red;
	 * borderRound=8"
	 */
	@XStreamAsAttribute
	...
	/**
	 * 整行的背景色、文字色表达式 表达式, 如: displayMask = "bgColor=if(price=0, red, transparent); textColor=if(price>2,#000022, blue)"
	 */
	@XStreamAsAttribute
	...
	public Properties(SupProperties supProperties) {
		this();
		BeanUtils.copyProperties(supProperties, this);
