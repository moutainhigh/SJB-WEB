...
import sijibao.oa.jeesite.persistence.DataEntity;
import sijibao.oa.jeesite.supcan.annotation.treelist.cols.SupCol;
...
public class User extends DataEntity<User> {
	...
	private String oldNo;//原登录工号
	private String oldMobile;//原手机号
	private String year;//报表查询
	...
	public User(String id, String loginName, String dingId, String wechatId,String phone){
		super(id);
		this.loginName = loginName;
		this.dingId = dingId;
	...
	@ExcelField(title="手机号(文本格式)*", align=2, sort=500)
...
//	@NotNull(message="角色名称不能为空")
	@ExcelField(title="用户角色*", align=1, sort=800)
...
//	@ExcelField(title="拥有角色", align=1, sort=800, fieldType=RoleListType.class)
	...
	@ExcelField(title="职级", align=1, sort=690)
