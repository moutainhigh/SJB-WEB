...
import com.sijibao.oa.modules.cms.dao.CategoryDao;
import com.sijibao.oa.modules.cms.entity.Category;
import com.sijibao.oa.modules.cms.entity.Site;
import com.sijibao.oa.modules.cms.utils.CmsUtils;
...
public class CategoryService extends TreeService<CategoryDao, Category> {
	...
	public List<Category> findByUser(boolean isCurrentSite, String module){
		...
		List<Category> list = (List<Category>) UserUtils.getFromSession(CACHE_CATEGORY_LIST);
		if (list == null){
...
//				list.addAll(0, dao.find(dc));
			...
			UserUtils.putIntoSession(CACHE_CATEGORY_LIST, list);
		}
...
//		return page;
	...
	public void save(Category category) {
		...
		super.save(category);
		UserUtils.removeFromSession(CACHE_CATEGORY_LIST);
