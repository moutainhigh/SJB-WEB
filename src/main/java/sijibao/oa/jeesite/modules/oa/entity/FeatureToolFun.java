 ...
 *
 */
public class FeatureToolFun extends DataEntity<FeatureToolFun> {
	...
	@ExcelField(title="修改总时间(小时)", align=2, sort=300)
	...
	@ExcelField(title="修改总单数", align=2, sort=400)
	...
	@ExcelField(title="修改总次数", align=2, sort=500)
