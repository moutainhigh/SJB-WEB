 ...
 **/
@ApiModel(value="提醒管理服务--查询列表对象")
public class MainMessageRemindSaveReq implements Serializable {
    ...
    public String toString() {
        return "MainMessageRemindSaveReq{" +
                "id='" + id + '\'' +
                ...
                ", startTime=" + startTime +
                ", isWeek=" + isWeek +
                ", pollHourMin='" + pollHourMin + '\'' +
                ", pollMonth=" + pollMonth +
                ", pollMonthday=" + pollMonthday +
                ", pollWeek=" + pollWeek +
                ", pollWeekday=" + pollWeekday +
