...
import com.sijibao.oa.modules.intfz.request.report.ProjectSubjectCostReportRequest;
...
public class IntfzProjectSubjectCostReportService extends BaseService {
	 ...
	 * @return
	 */
	public Page<SubjectCostReportResponse> queryProjectSubjectCostReportInfo(Page<SubjectCostReportResponse> page,ProjectSubjectCostReportRequest req){
		...
		subjectCostReport.setProjectId(req.getProjectId());
		subjectCostReport.setBeginTime(DateUtils.getYearFirst(year)); //开始时间
		subjectCostReport.setEndTime(DateUtils.getYearLast(year)); //结束时间
		Page<SubjectCostReport> subjectInfoPage = 
				subjectCostReportService.querySubjectInfoForProjectId(new Page<SubjectCostReport>(req.getPageNo(), req.getPageSize()), subjectCostReport);
		...
		for(SubjectCostReport s:subjectInfoPage.getList()){
			...
			subjectCostReportResponse.setIsDetail("0"); //是否有明细
	 ...
	 * @return
	 */
	public List<SubjectCostReportResponse> queryProjectSubjectCostReportInfo(ProjectSubjectCostReportRequest req){
		...
		subjectCostReport.setBeginTime(DateUtils.getYearFirst(year)); //开始时间
		subjectCostReport.setEndTime(DateUtils.getYearLast(year)); //结束时间
		List<SubjectCostReport> subjectInfoList = subjectCostReportService.querySubjectInfoForProjectId(subjectCostReport);
	 ...
	 * @return
	 */
	public String exportProjectSubjectCostReport(ProjectSubjectCostReportRequest req,String fileName){
		
		List<SubjectCostReportResponse> resultList = this.queryProjectSubjectCostReportInfo(req); //查询所有报表数据
	 ...
	 * @return
	 */
	public ReportMonthSumResponse querySubjectMonthSum(ProjectSubjectCostReportRequest req){
		...
		sc.setBeginTime(DateUtils.getYearFirst(year)); //开始时间
		sc.setEndTime(DateUtils.getYearFirst(year+1)); //结束时间
		List<MonthAmountSumReport> monthAmountList = subjectCostReportService.queryMonthAmountSum(sc);
