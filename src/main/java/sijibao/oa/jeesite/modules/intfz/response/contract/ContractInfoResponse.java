...
public class ContractInfoResponse{
	...
	private String contractStatusTxt;		// 合同状态
	...
	public String getContractStatusTxt() {
		return contractStatusTxt;
	}

	public void setContractStatusTxt(String contractStatusTxt) {
		this.contractStatusTxt = contractStatusTxt;
	}
	...
	public String toString() {
		return "ContractInfoResponse [id=" + id + ", contractCode=" + contractCode + ", contractName=" + contractName
				...
				+ createTime + ", contractStatus=" + contractStatus + ", contractStatusTxt=" + contractStatusTxt
